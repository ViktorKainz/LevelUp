...
public class Materials {
    ...
    public static final ToolMaterial SAPPHIRE_TOOL_MATERIAL = EnumHelper.addToolMaterial("RUBY",
            3, 2000, 10F, 4.0F, 15);
    ...
    public static final ArmorMaterial SAPPHIRE_ARMOR_MATERIAL = EnumHelper.addArmorMaterial("RUBY",
            LevelUp.MODID + ":ruby", 40, new int[]{4, 7, 9, 4}, 15,
