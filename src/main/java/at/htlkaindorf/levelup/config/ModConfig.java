...
public class ModConfig {
    ...
    public static String[] groups = {
            ...
            "Ruby Fighting Tools,Fighting,8",
            "Sapphire Fighting Tools,Fighting,9",
            "Wither Fighting Tools,Fighting,10",
            "Ender Fighting Tools,Fighting,11",
            ...
            "Ruby Farming Tools,Farming,7",
            "Sapphire Farming Tools,Farming,8",
            "Wither Farming Tools,Farming,9",
            "Ender Farming Tools,Farming,10",
    ...
    public static String[] groupsRecipes = {
            ...
            "Stone Farming Tools,minecraft:stone_hoe",
            "Iron Farming Tools,minecraft:iron_hoe",
            "Gold Farming Tools,minecraft:golden_hoe",
            "Bone Meal Framing,minecraft:bone_meal_from_bone",
            "Diamond Farming Tools,minecraft:diamond_hoe",
            "Magma Farming Tools,levelup:magma/magma_hoe",
            "Ruby Farming Tools,levelup:ruby/ruby_hoe",
            "Sapphire Farming Tools,levelup:sapphire/sapphire_hoe",
            "Wither Farming Tools,levelup:wither/wither_hoe",
            "Ender Farming Tools,levelup:ender/ender_hoe",
